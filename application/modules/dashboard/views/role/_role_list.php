    ...
    <div class="col-sm-12 col-md-12">
            <div class="card">
                    ...
                    <small class="float-right">  
                        <a class="btn btn-primary btn-md" onclick="getrolepermission_form()" id="v-pills-rolepermission-tab" data-toggle="pill" href="#v-pills-rolepermission" > <i class="fa fa-plus-circle" aria-hidden="true"></i> Role Permission</a>
                    </small>
                    </h4>
                <div class="card-body">
