                ...
                <?php echo form_open('hrm/salary-generate-update/'. $data->ssg_id) ?>
                    ...
                    <input name="ssg_id" type="hidden" value="<?php echo html_escape($data->ssg_id) ?>">
                       ...
                       <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="fin_datepicker form-control" name="start_date" placeholder="<?php echo display('start_date') ?>" id="start_date"  value="<?php echo  html_escape($data->start_date)?>">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="fin_datepicker form-control" name="end_date" placeholder="<?php echo display('end_date') ?>" id="end_date" value="<?php echo  html_escape($data->end_date)?>">
