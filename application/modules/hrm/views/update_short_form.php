                ...
                <?php echo form_open_multipart('hrm/shortlist-update/'. $data->can_short_id) ?>
                    ...
                    <input name="can_short_id" type="hidden" value="<?php echo html_escape($data->can_short_id) ?>">
                       ...
                       <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="date_of_shortlist" class="fin_datepicker form-control" id="date_of_shortlist" value="<?php echo html_escape($data->date_of_shortlist)?>">
                            </div>
                        </div> 
                       <div class="form-group row">
                            <label for="interview_date" class="col-sm-3 col-form-label"><?php echo display('interview_date') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-6">
                                <input type="text" name="interview_date" class="fin_datepicker form-control" id="interview_date" value="<?php echo html_escape($data->interview_date)?>">
                            </div>
                        </div> 
