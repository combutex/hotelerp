            ...
            <div class="panel">
                ...
                <?php echo form_open_multipart('hrm/Leave/application') ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="apply_date" class="fin_datepicker form-control" id="f">   
                            </div>   
                        </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="apply_strt_date" class="fin_datepicker form-control" id="e">
                               
                            </div>
                            <label for="apply_end_date" class="col-sm-2 col-form-label">
                            <?php echo display('apply_end_date') ?></label>
                            <div class="col-sm-4">
                           <input type="text" name="apply_end_date" class="fin_datepicker form-control" id="a">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="leave_aprv_strt_date" class="fin_datepicker form-control leave_aprv_strt_date" id="b">
                               
                            </div>
                            <label for="leave_aprv_end_date" class="col-sm-2 col-form-label">
                            <?php echo display('leave_aprv_end_date') ?></label>
                            <div class="col-sm-4">
                           <input type="text" name="leave_aprv_end_date" class="fin_datepicker form-control leave_aprv_end_date" id="c">
