                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="work_hour"><?php echo display('hire_date')?> <sup
                                                class="color-red text-danger">*</sup></label>
                                        <input type="text" class="form-control fin_datepicker width_480px" name="hiredate"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fin_datepicker" name="ohiredate"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fin_datepicker" name="terminatedate"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fin_datepicker" name="rehiredate"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="pay_frequency" id="pay_frequency" class="form-control">
                                            ...
                                            echo display('selected');
                                        }?>><?php echo display('monthly') ?></option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fin_datepicker" id="benifit_acc_date"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="l_name"><?php echo display('benifit_acc_date')?> </label>
                                        <input type="text" class="form-control fin_datepicker" name="benifit_acc_date[]"
                                            placeholder="<?php echo display('benefit_accrual_date')?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control fin_datepicker"
                                                name="benifit_acc_date[]"
                                                placeholder="<?php echo display('benefit_accrual_date')?>">
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fin_datepicker" id="class_acc_date"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="s_name"><?php echo display('dob')?><sup
                                                class="color-red text-danger">*</sup></label>
                                        <input type="text" class="form-control fin_datepicker" id="dob" name="dob"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="ssn">Aadhaar</label>
                                        <input type="text" class="form-control" id="ssn" name="ssn" placeholder="Enter your Aadhar number"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="citizenship" class="form-control">
                                          ...
                                          echo display('selected');
                                        }?>><?php echo display('Indian') ?></option>
                                            <option value="0" <?php if($data->citizenship==0){
                                          echo display('selected');
                                        }?>><?php echo display('NRI') ?></option>
                                        </select>
                                    </div>
                                </div>
