        ...
        <div class="col-sm-12 col-md-12">
            ...
            <?php echo form_open('hrm/salary-generate') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="fin_datepicker form-control" name="start_date" placeholder="<?php echo display('s_date') ?>" id="start_date">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="fin_datepicker form-control" name="end_date" placeholder="<?php echo display('e_date') ?>" id="end_date">
