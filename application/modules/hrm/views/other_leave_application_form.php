            ...
            <div class="card">
                ...
                <?php echo form_open_multipart('hrm/leave-application') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                           <input type="text" name="leave_aprv_strt_date" class="fin_datepicker form-control leave_aprv_strt_date" id="leave_aprv_strt_date" placeholder="<?php echo display('leave_aprv_strt_date') ?>">
                               
                            </div>
                             <label for="" class="col-sm-3 col-form-label">
                            <?php echo display('leave_aprv_end_date') ?></label>
                            <div class="col-sm-3">
                           <input type="text" name="leave_aprv_end_date" class="fin_datepicker form-control leave_aprv_end_date" id="leave_aprv_end_date" placeholder="<?php echo display('leave_aprv_end_date') ?>">
