    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4><?php echo display('report_view') ?>
                                ...
                                <div class="form-group row">
                                    <label for="date"
                                        class="col-sm-3 col-form-label"><?php echo display('start_date') ?> <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-9">
                                        <input name="s_date" class="fin_datepickers form-control" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="start_date" value="<?php echo date('Y-m-d') ?>"
                                            class="fin_datepickers form-control" type="text" placeholder="<?php
