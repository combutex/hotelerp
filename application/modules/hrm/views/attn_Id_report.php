            ...
            <div class="card-header">
                ...
                <?php echo form_open('hrm/attend-report-list','name="myForm"') ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="s_date" class="fin_datepicker form-control" type="text" placeholder="<?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="e_date" class="fin_datepicker form-control" type="text" placeholder="<?php  
