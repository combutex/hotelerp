                    ...
                    <input name="loan_id" type="hidden" value="<?php echo html_escape($data->loan_id) ?>">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="date_of_approve" class="fin_datepicker form-control"  placeholder="<?php echo display('date_of_approve') ?>" id="date_of_approve"  value="<?php echo html_escape($data->date_of_approve) ?>" autocomplete="off">
                            </div>
                        </div> 
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="repayment_start_date" class="fin_datepicker form-control"  placeholder="<?php echo display('repayment_start_date') ?>" value="<?php echo html_escape($data->repayment_start_date) ?>"  id="repayment_start_date" autocomplete="off">
                            </div>
                        </div> 
                        <div class="form-group row">
