                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="work_hour"><?php echo display('hire_date')?> <sup
                                                class="color-red ">*</sup></label>
                                        <div class="input__holder2">
                                            <input type="text" class="form-control fin_datepicker width_480px"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control fin_datepicker" name="terminatedate"
                                            id="terminatedate" placeholder="Termination date">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="citizenship" class="form-control">
                                            <option value="1"> <?php echo display('Indian')?></option>
                                            <option value="0"> <?php echo display('NRI')?></option>
                                        </select>
                                    </div>
                                </div>
