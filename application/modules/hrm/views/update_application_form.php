                    ...
                    <input name="leave_appl_id" type="hidden" value="<?php echo html_escape($data->leave_appl_id) ?>">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="apply_strt_date" class="fin_datepicker form-control apply_start" id="apply_start" placeholder="<?php echo display('apply_strt_date') ?>" value="<?php echo html_escape($data->apply_strt_date) ?>">
                            </div>
                             <label for="apply_end_date" class="col-sm-2 col-form-label">
                            <?php echo display('apply_end_date') ?><span class="text-danger">*</span></label>
                            <div class="col-sm-4">
                           <input type="text" name="apply_end_date" class="fin_datepicker form-control apply_end" id="apply_end" value="<?php echo html_escape($data->apply_end_date) ?>" placeholder="<?php echo display('apply_end_date') ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                           <input type="text" name="leave_aprv_strt_date" class="fin_datepicker form-control leave_aprv_strt_date" value="<?php echo html_escape($data->leave_aprv_strt_date) ?>" id="leave_aprv_strt_date" placeholder="<?php echo display('leave_aprv_strt_date') ?>">
                               
                            </div>
                             <label for="" class="col-sm-2 col-form-label">
                            <?php echo display('leave_aprv_end_date') ?></label>
                            <div class="col-sm-4">
                           <input type="text" name="leave_aprv_end_date" class="fin_datepicker form-control leave_aprv_end_date" value="<?php echo html_escape($data->leave_aprv_end_date) ?>" id="leave_aprv_end_date" placeholder="<?php echo display('leave_aprv_end_date') ?>">
