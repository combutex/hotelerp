...
<?php endif; ?></small></h4>
               ...
               <input type="hidden" name="job_adv_id" class="form-control" value="<?php echo html_escape($data->job_adv_id)?>">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="interview_date" class="fin_datepicker form-control"  placeholder="<?php echo display('interview_date') ?>" id="interview_date" value="<?php echo html_escape($data->interview_date)?>">
                            </div>
