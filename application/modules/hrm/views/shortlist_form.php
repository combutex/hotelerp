                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="date_of_shortlist" class="fin_datepicker  form-control width_300" placeholder="<?php echo display('date_of_shortlist') ?>" id="date_of_shortlist" value="<?php echo date('Y-m-d') ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="interview_date" class="col-sm-3 col-form-label"><?php echo display('interview_date') ?> <span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="text" name="interview_date" class="fin_datepicker  form-control width_300" placeholder="<?php echo display('interview_date') ?>" id="interview_date">
                                        </div>
                                    </div>
