                ...
                <div class="row" id="">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="dtpFromDate" value="<?php echo date('Y-m-d') ?>" placeholder="<?php echo display('date') ?>" class="fin_datepicker form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="dtpToDate" value="<?php echo date('Y-m-d') ?>" placeholder="<?php echo display('date') ?>" class="fin_datepicker form-control">
                            </div>
                        </div>
