<div class="card">
    ...
    <div class="card-header">
        <h4><?php echo display('room_list') ?> <small class="float-right">
                <!-- <button type="button" class="btn btn-primary btn-md mb-2" data-target="#add1" data-toggle="modal"><i
                    ...
                    <button type="button" class="btn btn-primary btn-md mb-2" data-target="#add0" data-toggle="modal"><i
                        class="ti-plus" aria-hidden="true"></i>
                    <?php echo display('add_new') ?></button>&nbsp;
                    <a href="<?php echo base_url("room_setting/assign-room") ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input name="roomsize" autocomplete="off" class="form-control" type="number"
                                                placeholder="Sqft" id="roomsize" value="">
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="bedsno" class="selectpicker form-control"
                                                ...
                                                <option value="" selected="selected">
                                                    ...
                                                    <option value="2">Non Luxury  </option>
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
    ...
    <!-- property model-->
        <div id="add1" class="modal fade" role="dialog">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <strong><?php echo display('add_new'); ?> sss</strong>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php echo form_open('room_setting/room_details/pcreate'); ?> 
                                        <div class="form-group row">
                                            <label for="propertyname"
                                                class="col-sm-4 col-form-label"><?php echo display('property_name') ?> <span
                                                    class="text-danger">*</span></label>
                                            <div class="col-sm-8">
                                                <input name="propertyname" autocomplete="off" class="form-control" type="text"
                                                    placeholder="<?php echo display('property_name') ?>" id="propertyname" value="">
                                            </div>
                                        </div>                                       
                                        <div class="form-group row">
                                            <label for="roomdescription"
                                                class="col-sm-4 col-form-label"><?php echo display('property_desc') ?>
                                                <span class="text-danger">*</span></label>
                                            <div class="col-sm-8">
                                                <textarea name="propertydescription" cols="35" rows="3"
                                                    placeholder="<?php echo display('property_desc') ?>"></textarea>
                                            </div>
                                        </div>
