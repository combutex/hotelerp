    ...
    <div class="invoice-wrap print-content invp-1">
        ...
        <div class="invp-7">
            <div>
                ...
                <span
                    class="invp-10"><?php echo display("website") ?>:&nbsp;</span><?php echo "https://www.iringasunset.com/"; ?><br>
            </div>
            <div class="invp-11">
                <p class="invp-8">
        ...
        <table class="invp-13">
            <thead>
                <tr>
                    ...
                    <th class="invp-15"><?php echo"Room Rate Bills" ?></th>
                </tr>
            </thead>
            <tbody>
                <?php $allinvat = 0;?>
                ...
                <tr>
                    ...
                    <td class="invp-16">
                        <table class="invp-17">
                            <thead>
                                <tr>
                                    <th class="1nvp-18"><?php echo "NoD Rate" ?></th>
                                    <th class="1nvp-18"><?php echo "Rate" ?></th>
                                    <th class="1nvp-18"><?php echo "Rate"." ".display("discount"); ?></th>
                                    <th class="1nvp-18"><?php echo display("dis_day") ?></th>
                                    <th class="1nvp-18"><?php echo display("aft_dis") ?></th>
                                    <th class="1nvp-18"><?php echo "Total Rate" ?></th>
                                    <?php foreach($taxsetting as $tax){ ?>
        ...
        <div class="invp-30">
            <div class="invp-31">
                <?php echo "PAYMENT METHOD" ?></div>
            <ul class="invp-32">
                <li>NMB BANK <span style="color: red;" >60510032029 </span> SWIFT CODE:NMIBTZTZ</li>
               
                <li>NBC BANK <span style="color: red;" >028103005873 </span>SWIFT CODE:NLCBTZTX</li>
            </ul>
        </div>
        <!--/Terms and conditions-->
        <!--Signatory-->
