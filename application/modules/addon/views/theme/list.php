                    ...
                    <div class="panel-body">
                       ...
                       <?php $this->load->view('template/includes/messages'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <label><?php echo display('purchase_key') ?> <span class="glyphicon glyphicon-question-sign" data-toggle="tooltip" data-placement="bottom" title="Enter access code shared by CodeAir"></span></label>
