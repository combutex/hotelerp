        ...
        <div class="col-sm-12">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input name="dob" autocomplete="off" class="fin_datepicker form-control" type="text" placeholder="<?php echo display('dob') ?>" id="dob" value="<?php echo html_escape((!empty($intinfo->dob)?$intinfo->dob:null)) ?>">
                    </div>
